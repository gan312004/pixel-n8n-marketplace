    ...
    const sampleTemplates = [
        {
            ...
            featured: true,
            features: JSON.stringify(['GPT-4 Integration', 'Multi-format output', 'SEO optimization']),
        ...
        },
        {
            ...
            featured: true,
            features: JSON.stringify(['Multi-CRM support', 'Real-time sync', 'Conflict resolution']),
            requirements: JSON.stringify(['n8n 1.0+', 'CRM API access']),
            image: null,
        ...
        },
        {
            ...
            featured: false,
            features: JSON.stringify(['A/B testing', 'Segmentation', 'Analytics']),
